...
/**
 * Diretórios de usuário (não por-projeto) do Atlas Cortex, seguindo XDG quando
 ...
 * global do daemon, distinto do `.cortex/` por-projeto.
 */

const PRODUCT_SUBDIR = "atlas-cortex";
