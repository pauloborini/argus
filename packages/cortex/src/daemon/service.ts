...
const SYSTEMD_UNIT = "atlas-cortex.service";
 ...
 * plataformas degradam honesto (instrui rodar `cortex daemon` manualmente).
 */
export function installService(): ServiceResult {
  ...
  return {
    ok: false,
    message: `Plataforma ${process.platform} sem serviço gerenciado; rode 'cortex daemon' manualmente.`,
  };
}
