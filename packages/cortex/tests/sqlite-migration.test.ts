...
describe("sqlite-migration", () => {
  ...
  it("importStructuralIndexFromJson preserva contagens", () => {
    tempDir = mkdtempSync(join(tmpdir(), "cortex-sqlite-migrate-"));
  ...
  it("tryBootstrapIndexFromLegacyJson importa quando DB ausente", () => {
    tempDir = mkdtempSync(join(tmpdir(), "cortex-sqlite-bootstrap-"));
    mkdirSync(join(tempDir, ".cortex"), { recursive: true });
